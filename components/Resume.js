        ...
        <div className="col-left flex items-center justify-between flex-wrap min-w-[100%]">
          <div className="flex-[47%] w-[47%] h-[100%] self-center relative bg-[#FEF6E3] rounded-[50%]">
            ...
            <div className="resume-social h-0 w-0 max-h-0">
              <Link href="/#twitter">
                <a
                  className="absolute flex items-center justify-center top-0 left-0 bg-[#C6C7AD] h-[120px] w-[120px] rounded-[50%] opacity-80"
                  title="Twitter"
                >
              ...
              <Link href="/#github">
                <a
                  className="absolute flex items-center justify-center bottom-0 left-0 bg-[#C6C7AD] h-[120px] w-[120px] rounded-[50%] opacity-80"
                  title="Github"
                >
              ...
              <Link href="/#linkedin">
                <a
                  className="absolute flex items-center justify-center top-0 right-0 bg-[#C6C7AD] h-[120px] w-[120px] rounded-[50%] opacity-80"
                  title="Linkedin"
                >
              ...
              <Link href="/#facebook">
                <a
                  className="absolute flex items-center justify-center bottom-0 right-0 bg-[#C6C7AD] h-[120px] w-[120px] rounded-[50%] opacity-80"
                  title="Facebook"
                >
