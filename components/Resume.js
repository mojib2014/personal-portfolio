    ...
    >
      <SectionContainer>
        ...
        <div className="grid auto-row-auto gap-10 justify-center md:grid-cols-2 lg:grid-cols-2">
          <div className="self-center relative bg-neutral-100 dark:bg-gray-500 rounded-full">
            ...
            >
              <Link
                ...
                className="absolute flex items-center justify-center top-0 left-0 bg-[#FEF6E3] h-16 w-16 md:h-[120px] md:w-[120px] rounded-[50%] opacity-90"
                title="Twitter"
                aria-label="Twitter"
              >
              ...
              <Link
                ...
                className="absolute flex items-center justify-center bottom-0 left-0 bg-[#FEF6E3] h-16 w-16 md:h-[120px] md:w-[120px] rounded-[50%] opacity-90"
                title="Github"
                aria-label="Github"
              >
              ...
              <Link
                ...
                className="absolute flex items-center justify-center top-0 right-0 bg-[#FEF6E3] h-16 w-16 md:h-[120px] md:w-[120px] rounded-[50%] opacity-90"
                title="Linkedin"
                aria-label="Linkedin"
              >
              ...
              <Link
                href="/#facebook"
                className="absolute flex items-center justify-center bottom-0 right-0 bg-[#FEF6E3] h-16 w-16 md:h-[120px] md:w-[120px] rounded-[50%] opacity-90"
                title="Facebook"
                aria-label="Facebook"
              >
          ...
          <div className="py-3 self-start sm:self-center md:pl-[120px] w-full">
